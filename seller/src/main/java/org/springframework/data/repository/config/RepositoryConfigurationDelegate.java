    ...
    public List<BeanComponentDefinition> registerRepositoriesIn(BeanDefinitionRegistry registry,
        ...
        for (RepositoryConfiguration<? extends RepositoryConfigurationSource> configuration : extension
            ...
            if (metadata.hasAnnotation(Primary.class.getName())) {
                ...
                Map<String, Object> map = metadata.getAnnotationAttributes(RepositoryBeanNamePrefix.class.getName());
                String name = (String) map.get("value");
                beanName = name + beanName.substring(0, 1).toUpperCase() + beanName.substring(1);
            }
